<template>
  <div class="flex flex-col">
    ...
    <section class="bg-gray-900">
      <div class="mx-auto py-8 px-8 md:px-32 sm:py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-16">
          <div class="space-y-8">
            <div>
              <div
                class="bg-white mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12"
              >
                <svg
                  class="text-primary-300 h-5 w-5 lg:h-6 lg:w-6"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <h3 class="mb-2 text-xl font-bold text-white">Create</h3>
              <p class="text-gray-400">
                Write it, build it, create it. Choose from many of our
                professionally designed resume templates to create your own
                professional resume seamlessly.
              </p>
            </div>
            <div>
              <div
              ...
              <h3 class="mb-2 text-xl font-bold text-white">Optimize</h3>
              <p class="text-gray-400">
                Use our AI-powered suggestion engine to optimize your resume
                bullet points, to ensure that it catches any recruiter's eye.
              </p>
            </div>
          </div>
          <div class="m-auto">
